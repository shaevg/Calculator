...
${OBJECTDIR}/calculator.o: calculator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/calculator.o calculator.cpp
...
${TESTDIR}/tests/CalculatorTestClass.o: tests/CalculatorTestClass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CalculatorTestClass.o tests/CalculatorTestClass.cpp


${TESTDIR}/tests/calculatorTestRunner.o: tests/calculatorTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/calculatorTestRunner.o tests/calculatorTestRunner.cpp


${TESTDIR}/tests/ExpressionTestClass.o: tests/ExpressionTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ExpressionTestClass.o tests/ExpressionTestClass.cpp


${TESTDIR}/tests/expressionTestRunner.o: tests/expressionTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/expressionTestRunner.o tests/expressionTestRunner.cpp


${TESTDIR}/tests/NumberTestClass.o: tests/NumberTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NumberTestClass.o tests/NumberTestClass.cpp


${TESTDIR}/tests/numberTestRunner.o: tests/numberTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/numberTestRunner.o tests/numberTestRunner.cpp
...
${OBJECTDIR}/calculator_nomain.o: ${OBJECTDIR}/calculator.o calculator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/calculator_nomain.o calculator.cpp;\
	else  \
...
${OBJECTDIR}/core_nomain.o: ${OBJECTDIR}/core.o core.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core_nomain.o core.cpp;\
	else  \
...
${OBJECTDIR}/expression_nomain.o: ${OBJECTDIR}/expression.o expression.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/expression_nomain.o expression.cpp;\
	else  \
...
${OBJECTDIR}/number_nomain.o: ${OBJECTDIR}/number.o number.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/number_nomain.o number.cpp;\
	else  \
